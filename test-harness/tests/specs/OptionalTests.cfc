	...
	function run(){
		describe( "CB Optional", function(){
			story( "I can create optionals", function(){
				given( "nothing to the constructor", function(){
					then( "it should build an empty optional", function(){
						var optional = new cbproxies.models.Optional();
			...
			it( "can equal optionals", function(){
				...
				expect( optional.isEqual( createObject( "java", "java.util.Optional" ).of( "joe" ) ) ).toBeFalse();

				expect( optional.isEqual( createObject( "java", "java.util.Optional" ).of( "luis" ) ) ).toBeTrue();
			} );
			...
			it( "can invoke if present consumers", function(){
				...
				var optional = new cbproxies.models.Optional().of( "luis" );
				optional.ifPresent( function( e ){
					consumerValue = e;
				} );
			...
			it( "can return orElse() ", function(){
				...
				var optional = new cbproxies.models.Optional().of( "alexia" );
